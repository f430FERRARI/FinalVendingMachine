...
public class Utilities {
	...
	/**
	 * Convenience method for checking the contents of product racks. Empties
	 * the product racks.
	 *
	 * @param expectedList
	 *            The names of the products expected to be present. Can be an
	 *            empty list. The same string can be repeated as necessary. The
	 *            order is not significant.
	 * @return true if the actual products have the exactly the same names as
	 *         the expected ones else false
	 */
	...
	/**
	 * A convenience method for constructing and loading a set of product cans
	 * into the machine.
	 * 
	 * @param productCounts
